...
class SaleRecord:
    ...
    def __init__(self, sale_id="", com_id="", com_name="", quantity=0, 
                 ...
                 customer_name="", sale_date="", sale_unit="克"):
        self.sale_id = sale_id
        self.com_id = com_id
        self.com_name = com_name
        self.quantity = quantity  # 销售数量（可能为克或斤）
        ...
        self.sale_unit = sale_unit  # 销售单位（克或斤）
    ...
    def to_list(self):
        ...
        return [
            ...
            self.customer_name, self.sale_date, self.sale_unit
        ]
